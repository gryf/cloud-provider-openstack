...
require (
	...
	k8s.io/apiextensions-apiserver v0.29.0-alpha.2 // indirect
	k8s.io/component-helpers v0.29.0-alpha.2 // indirect
	k8s.io/controller-manager v0.29.0-alpha.2 // indirect
	k8s.io/csi-translation-lib v0.29.0-alpha.2 // indirect
	k8s.io/kube-openapi v0.0.0-20230905202853-d090da108d2f // indirect
	k8s.io/kubectl v0.29.0-alpha.2 // indirect
	k8s.io/kubelet v0.29.0-alpha.2 // indirect
	k8s.io/pod-security-admission v0.29.0-alpha.2 // indirect
